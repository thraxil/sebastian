...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('leitner_card', 'deck_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['leitner.Deck']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Card.deck'
        db.alter_column('leitner_card', 'deck_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leitner.Deck'], null=True))
