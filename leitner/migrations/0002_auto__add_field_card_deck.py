...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('leitner_card', 'deck', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leitner.Deck'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.deck'
        db.delete_column('leitner_card', 'deck_id')
